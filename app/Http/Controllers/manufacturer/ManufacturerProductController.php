...
class ManufacturerProductController extends Controller
{
    ...
    {
        $query = Auth::user()->manufacturer->products();
    ...
    {
        return view('manufacturer.products.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $product = Auth::user()->manufacturer->products()->create([
            'name' => $validated['name'],
        ...
        return response()->json([
            ...
            'redirect' => route('manufacturer.products.index')
        ]);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('manufacturer.products.show', compact('product'));
    }

    public function edit(string $id)
    {
        $product = Auth::user()->manufacturer->products()->findOrFail($id);
        return view('manufacturer.products.edit', compact('product'));
    }
    ...
    public function bulkDelete(Request $request)
    {
        if (!Auth::guard('manufacturer')->check()) {
            return redirect()->route('login')->with('error', 'You are not logged in as a manufacturer');
        }
        ...
        $products = auth('manufacturer')->user()->products()->whereIn('id', $ids)->get();
