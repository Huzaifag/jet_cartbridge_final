...
class productController extends Controller
{
    ...
    {
        $product = Auth::user()->salesman->seller->products()->findOrFail($id);
    ...
    {
        $product = Auth::user()->salesman->seller->products()->findOrFail($id);
        return view('salesman.products.edit', compact('product'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('salesman.products.index')
    ...
    public function bulkDelete(Request $request)
    {
        if (!Auth::guard('salesman')->check()) {
            return redirect()->route('login')->with('error', 'You are not logged in as a salesman');
        }
        ...
        $products = Auth::user()->salesman->seller->products()->whereIn('id', $ids)->get();
