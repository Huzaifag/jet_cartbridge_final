...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('manufacturer.employees.salesman.index') }}" class="btn btn-secondary">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('manufacturer.employees.salesman.update', $salesman) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
