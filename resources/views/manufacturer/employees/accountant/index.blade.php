...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('manufacturer.employees.accountant.create') }}" class="btn btn-primary">
        ...
        <!-- ✅ Filters & Search -->
        <form method="GET" action="{{ route('manufacturer.employees.accountant.index') }}" class="row g-2 mb-4">
            <div class="col-md-4">
                        ...
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex justify-content-center gap-2 mt-3">
                                    <a href="{{ route('manufacturer.employees.accountant.show', $accountant->id) }}"
                                        class="btn btn-sm btn-primary">
                                        <i class="fas fa-eye"></i> Show
                                    </a>

                                    <a href="{{ route('manufacturer.employees.accountant.edit', $accountant->id) }}"
                                        class="btn btn-sm btn-info">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>

                                    <form action="{{ route('manufacturer.employees.accountant.destroy', $accountant->id) }}" method="POST"
