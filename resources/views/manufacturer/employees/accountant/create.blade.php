...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Add New Accountant</h2>
        <a href="{{ route('manufacturer.employees.accountant.index') }}" class="btn btn-secondary">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('manufacturer.employees.accountant.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select id="designation" name="designation" class="form-select">
                                ...
                                <option value="Senior Accountant" {{ old('designation') == 'Senior Accountant' ? 'selected' : '' }}>Senior Accountant</option>
                                <option value="Finance Manager" {{ old('designation') == 'Finance Manager' ? 'selected' : '' }}>Finance Manager</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" id="salary" name="salary" class="form-control" value="{{ old('salary') }}">
