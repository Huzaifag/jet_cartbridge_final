...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('manufacturer.employees.delivery.index') }}" class="btn btn-secondary">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('manufacturer.employees.delivery.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
