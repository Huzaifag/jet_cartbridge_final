        ...
        <div class="settings-container">
            ...
            <div class="settings-content">
                ...
                <div class="card content-section" id="payment-settings">
                    ...
                    <div class="card-body">
                        <form id="paymentForm" action="{{ route('manufacturer.payment-settings.store') }}" method="POST">
                            @csrf
                            @method('POST')
                ...
                <div class="card content-section" id="security-settings" style="display: none;">
                    ...
                    <div class="card-body">
                        ...
                        <form id="twoFactorForm" action="{{ route('manufacturer.twofactor.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <div class="notification-option">
                                    <label class="toggle-switch">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('saveNotificationSettings').addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    didOpen: () => {
                        Swal.showLoading();
                        fetch("{{ route('manufacturer.notification-preferences.store') }}", {
                            method: 'POST',
                            headers: {
            ...
            fetch("{{ route('manufacturer.notification-preferences.show') }}", {
                headers: {
                    'Accept': 'application/json'
                }
            })
            ...
            document.getElementById('saveTwoFactorSettings').addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        fetch("{{ route('manufacturer.twofactor.store') }}", {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': "{{ csrf_token() }}",
                                'Accept': 'application/json'
            ...
            document.getElementById('updatePassword').addEventListener('click', function() {
                ...
                fetch("{{ route('manufacturer.change-password') }}", {
                    method: 'POST',
                    headers: {
