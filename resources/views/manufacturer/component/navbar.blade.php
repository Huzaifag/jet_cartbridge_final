            ...
            <div class="user-dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button"
                    ...
                    <div class="avatar bg-primary text-white rounded-circle me-2">
                        ...
                        {{ collect(explode(' ', Auth::user()->manufacturer->company_name))->map(fn($w) => strtoupper(Str::substr($w, 0, 1)))->implode('') }}
                    </div>
                    <div class="d-none d-md-block">
                        <div class="fw-bold">{{ Auth::user()->manufacturer->company_name }}</div>
                        <div class="small text-muted">Manufacturer Account</div>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                    <li class="dropdown-header">
                        <h6 class="mb-0">{{ Auth::user()->manufacturer->company_name }}</h6>
                        <small class="text-muted">Manufacturer Account</small>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    ...
                    <li>
                        <form action="{{ route('manufacturer.logout') }}" method="POST">
                            @csrf
