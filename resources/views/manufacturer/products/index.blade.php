...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0">Manufacturer Products</h2>
            <div>
                <a href="{{ route('manufacturer.products.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus me-2"></i>Add New Product
                </a>
                <a href="{{ route('manufacturer.products.createBulk') }}" class="btn btn-secondary">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="filter-section">
                    <form action="{{ route('manufacturer.products.index') }}" method="GET">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="filter-tags">
                                @if (request('search'))
                                    <div class="filter-tag">
                                        ...
                                        <a href="{{ route('manufacturer.products.index', array_merge(request()->except('search'), ['page' => 1])) }}"
                                            class="close">&times;</a>
                                    </div>
                                @endif
                                ...
                                @if (request('status'))
                                    <div class="filter-tag">
                                        ...
                                        <a href="{{ route('manufacturer.products.index', array_merge(request()->except('status'), ['page' => 1])) }}"
                                            class="close">&times;</a>
                                    </div>
                                @endif
                                ...
                                @if (request('stock_range'))
                                    <div class="filter-tag">
                                        ...
                                        <a href="{{ route('manufacturer.products.index', array_merge(request()->except('stock_range'), ['page' => 1])) }}"
                                            class="close">&times;</a>
                                    </div>
                                @endif
                                ...
                                @if (request('price_range'))
                                    <div class="filter-tag">
                                        ...
                                        <a href="{{ route('manufacturer.products.index', array_merge(request()->except('price_range'), ['page' => 1])) }}"
                                            class="close">&times;</a>
                                    </div>
                                @endif
                            </div>
                ...
                @if ($products->count() > 0)
                    ...
                    <form id="bulkDeleteForm" action="{{ route('manufacturer.products.bulk-delete') }}" method="POST"
                        class="mb-3">
                        @csrf
                        @method('DELETE')
                                ...
                                <div class="card h-100 product-card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3 text-end action-buttons">
                                            <a href="{{ route('manufacturer.products.edit', $product->id) }}"
                                                class="btn btn-sm btn-info">
                                                <i class="fas fa-edit me-1"></i>Edit
                                            </a>
                                            <form action="{{ route('manufacturer.products.destroy', $product->id) }}"
