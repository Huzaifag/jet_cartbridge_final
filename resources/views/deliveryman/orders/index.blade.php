...
@section('content')
    <div class="container-fluid py-4">
        ...
        <header class="mb-4 pb-3 border-bottom">
            <h1 class="fw-bolder mb-0 text-dark">Assigned Orders</h1>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="action-button-group">
                                        <a href="{{ route('deliveryman.orders.show', $order->id) }}"
                                            class="btn btn-sm btn-outline-info" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        @if($order->status === 'Dispatched')
                                            <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#deliverModal{{ $order->id }}" title="Mark as Delivered">
