...
<nav class="sidebar" style="overflow-y: auto; max-height: 100vh;">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('salesman.products.index') }}"
                class="nav-link {{ request()->routeIs('salesman.products.index') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('salesman.placed-orders.index') }}"
                class="nav-link {{ request()->routeIs('salesman.placed-orders.index') ? 'active' : '' }}">
