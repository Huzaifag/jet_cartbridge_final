                    ...
                    <div class="card-body">
                        <form id="productForm" method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-step active" data-step="1">
                                <h5 class="mb-4 border-bottom pb-2"><i class="fas fa-info-circle me-2 text-primary"></i>Basic Information</h5>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-text">
                                            <a href="{{ route('seller.categories.create') }}" target="_blank" class="text-primary">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="weight" step="0.01" min="0" placeholder="0.00">
                                        <div class="form-text">Optional: Enter the product weight in kilograms (e.g., 0.50)</div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between mt-4">
                                    <div></div>
                                    <button type="button" class="btn btn-primary next-step">Next: Pricing & Stock <i class="fas fa-arrow-right ms-2"></i></button>
                                </div>
                            </div>

                            <!-- Step 2: Pricing and Stock -->
                            <div class="form-step" data-step="2">
                                <h5 class="mb-4 border-bottom pb-2"><i class="fas fa-tags me-2 text-primary"></i>Pricing & Stock</h5>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" name="b2c_price" step="0.01" min="0" required placeholder="e.g., 19.99">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="number" class="form-control" name="b2c_compare_price" step="0.01" min="0" placeholder="e.g., 24.99">
                                            </div>
                                            <div class="form-text">Optional price to show a discount (e.g., a strikethrough price).</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 p-3 border rounded bg-light">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="number" class="form-control" name="b2b_price" step="0.01" min="0" placeholder="e.g., 12.50">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="b2b_moq" min="1" placeholder="e.g., 50">
                                            <div class="form-text">Minimum quantity required to get the wholesale price.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="button" class="btn btn-primary next-step">Next: Description <i class="fas fa-arrow-right ms-2"></i></button>
                                </div>
                            </div>

                            <!-- Step 3: Description -->
                            <div class="form-step" data-step="3">
                                <h5 class="mb-4 border-bottom pb-2"><i class="fas fa-align-left me-2 text-primary"></i>Description</h5>
                                <div class="mb-3">
                                    <label class="form-label">Product Description <span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="description" rows="6" required placeholder="Describe your product in detail..."></textarea>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <button type="button" class="btn btn-outline-secondary prev-step"><i class="fas fa-arrow-left me-2"></i>Previous</button>
                                    <button type="button" class="btn btn-primary next-step">Next: Specifications <i class="fas fa-arrow-right ms-2"></i></button>
                                </div>
                            </div>

                            <!-- Step 4: Specifications -->
                            <div class="form-step" data-step="4">
                                <h5 class="mb-4 border-bottom pb-2"><i class="fas fa-list-alt me-2 text-primary"></i>Specifications</h5>
                                <div id="specifications-container">
                                    <div class="row g-3 mb-2 specification-row">
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="specifications[0][key]" placeholder="Specification Name (e.g., Color)">
                                        </div>
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="specifications[0][value]" placeholder="Specification Value (e.g., Red)">
                                        </div>
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn-danger remove-spec w-100" style="display: none;">
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <button type="button" class="btn btn-outline-secondary prev-step"><i class="fas fa-arrow-left me-2"></i>Previous</button>
                                    <button type="button" class="btn btn-primary next-step">Next: Images <i class="fas fa-arrow-right ms-2"></i></button>
                                </div>
                            </div>

                            <!-- Step 5: Images -->
                            <div class="form-step" data-step="5">
                                <h5 class="mb-4 border-bottom pb-2"><i class="fas fa-images me-2 text-primary"></i>Product Images</h5>
                                ...
                                <div class="row" id="image-preview-container">
                                    <div class="col-md-3 mb-3">
                                        <div class="image-upload-box">
                                            <input type="file" name="images[]" class="image-upload" accept="image/*" multiple>
        ...
        $(document).ready(function() {
            ...
            function validateStep(step) {
                ...
                if (step === 1) {
                    ...
                    const b2bPrice = $('input[name="b2b_price"]').val();
                    const stock = $('input[name="stock_quantity"]').val();

                    if (!price || price <= 0) {
                        showFieldError('input[name="b2c_price"]', 'Valid price is required');
                        isValid = false;
                    }

                    if (b2bPrice && b2bPrice <= 0) {
                        showFieldError('input[name="b2b_price"]', 'Wholesale price must be greater than 0');
                        isValid = false;
                    }
            ...
            $(document).on('change', '.image-upload', function(e) {
                ...
                const currentBox = $(this).closest('.image-upload-box');

                if (files && files.length > 0) {
                    // Handle multiple file selection
                    Array.from(files).forEach((file, index) => {
                        if (index === 0) {
                            // Use current box for first file
                            createImagePreview(file, currentBox);
                        } else {
                            // Create new boxes for additional files
                            const newBox = `
                                <div class="col-md-3 mb-3">
                                    <div class="image-upload-box">
                                        <input type="file" name="images[]" class="image-upload" accept="image/*" multiple style="display: none;">
                                        <div class="upload-placeholder" style="display: none;"></div>
                                        <img class="preview-image" style="display: none;">
                                    </div>
                                </div>`;
                            container.append(newBox);
                            const newImageBox = container.find('.image-upload-box').last();
                            createImagePreview(file, newImageBox);
                        }
                    });

                    // Add a new empty upload slot at the end
                    const uploadSlot = `
                        <div class="col-md-3 mb-3">
                            <div class="image-upload-box">
                                <input type="file" name="images[]" class="image-upload" accept="image/*" multiple>
