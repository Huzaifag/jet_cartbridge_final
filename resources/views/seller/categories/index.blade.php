                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-2">
                                <label class="form-label">&nbsp;</label>
                                <a href="{{ route('seller.categories.index') }}" class="btn btn-outline-secondary w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="{{ route('seller.categories.show', $category) }}" class="btn btn-sm btn-outline-info" title="View">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('seller.categories.edit', $category) }}" class="btn btn-sm btn-outline-warning" title="Edit">
